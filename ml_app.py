...
def run_ml_app():
    ...
    picklong = st.number_input(label="Pickup Location Longitude", min_value = -75.000000, max_value = -73.000000, value = -73.981880, step=0.000100,format="%.6f")
    picklat = st.number_input(label="Pickup Location Latitude", min_value = 40.500000, max_value = 41.500000, value = 40.752805, step=0.000100,format="%.6f")
    droplong = st.number_input(label="Dropoff Location Longitude", min_value = -75.000000, max_value = -73.000000, value = 73.981010, step=0.000100,format="%.6f")
    droplat = st.number_input("Dropoff Location Latitude", min_value = 40.500000, max_value = 41.500000, value = 40.752958, step=0.000100,format="%.6f")
